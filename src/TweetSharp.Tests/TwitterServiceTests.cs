...
namespace TweetSharp.Tests.Service
{
    ...
    public partial class TwitterServiceTests
    {
        ...
        [Test]
        public async void Can_get_direct_messages()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListDirectMessagesReceivedAsync(new ListDirectMessagesReceivedOptions());

            var dms = response.Content;
            ...
            AssertRateLimitStatus(response);
        }


        [Test]
        public async void Can_deserialize_dates()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListTweetsOnHomeTimelineAsync(new ListTweetsOnHomeTimelineOptions());
            var tweets = response.Content;
        ...
        [Test]
        public async void Can_get_mentions_and_fail_due_to_unauthorized_request()
        {
            var service = new TwitterService();
            var response = await service.ListTweetsMentioningMeAsync(new ListTweetsMentioningMeOptions());
            var mentions = response.Content;
        ...
        [Test]
        public async void Can_get_mentions()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListTweetsMentioningMeAsync(new ListTweetsMentioningMeOptions());
            var mentions = response.Content.ToList();

            Assert.IsTrue(response.RequestSucceeded);
            Assert.IsNotNull(mentions);
            Assert.IsTrue(mentions.Count() <= 20);

            var rate = response.RateLimitStatus;
        ...
        [Test]
        public async void Can_get_authenticated_user_profile()
        {
            var service = GetAuthenticatedService();
        ...
        [Test]
        public async void Can_get_user_profile_for()
        {
            var service = GetAuthenticatedService();
            var profile = await GetHeroProfile(service);
        ...
        public async void Can_tweet_with_geo()
        {
            ...
            var service = GetAuthenticatedService();
            var response = await service.SendTweetAsync(new SendTweetOptions { Status = DateTime.UtcNow.Ticks.ToString(), Lat = 56.95, Long = 24.1 });
            var tweet = response.Content;
        ...
        public async void Can_direct_message_with_screen_name()
        {
            ...
            var recipient = await GetHeroProfile(service);
            var response = await service.SendDirectMessageAsync(new SendDirectMessageOptions { ScreenName = recipient.ScreenName, Text = DateTime.UtcNow.Ticks.ToString() });
            var tweet = response.Content;
        ...
        private async Task<TwitterUser> GetHeroProfile(TwitterService service)
        {
            return (await service.GetUserProfileForAsync(new GetUserProfileForOptions { ScreenName = _hero })).Content;
        }
        ...
        public async void Can_tweet_with_special_characters()
        {
            ...
            var response = await service.SendTweetAsync(new SendTweetOptions { Status = message });
            var tweet = response.Content;
            Assert.IsNotNull(tweet);
            Assert.AreNotEqual(0, tweet.Id);
        }
        ...
        {
            var service = GetAuthenticatedService();
            var response = await service.SendTweetAsync(new SendTweetOptions { Status = DateTime.UtcNow.Ticks.ToString(), Lat = 45.43989910068863, Long = -75.69168090820312 });
            var tweet = response.Content;

            var uri = response.RequestUri;
            var location = Regex.Match(uri.Query, "location=([^&]*)").Groups[1].Value;
        ...
        public async void Can_tweet_and_handle_dupes()
        {
            ...
            await service.SendTweetAsync(new SendTweetOptions { Status = "Can_tweet_and_handle_dupes:Tweet" });
            var response = await service.SendTweetAsync(new SendTweetOptions { Status = "Can_tweet_and_handle_dupes:Tweet" });
            var error = response.Error;
            Assert.IsNotNull(error);
            Assert.IsNotNullOrEmpty(error.Message);
        ...
        public async void Can_tweet_with_image()
        {
            ...
            {
                var response = await service.SendTweetWithMediaAsync(new SendTweetWithMediaOptions
        ...
        [Test]
        public async void Can_get_followers_on_first_page()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListFollowersAsync(new ListFollowersOptions());
            var followers = response.Content;
            Assert.IsNotNull(followers);
        }

        [Test]
        public async void Can_get_friends_on_first_page()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListFriendsAsync(new ListFriendsOptions());
            var followers = response.Content;
            Assert.IsNotNull(followers);
        }

        [Test]
        public async void Can_get_followers_from_authenticated_user()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListFollowersAsync(new ListFollowersOptions());
            var followers = response.Content;
        ...
        [Test]
        public async void Can_get_favorites_for()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListFavoriteTweetsAsync(new ListFavoriteTweetsOptions { ScreenName = _hero });
            var tweets = response.Content;
        ...
        [Test]
        public async void Can_create_and_destroy_favorite()
        {
            // http://twitter.com/#!/kellabyte/status/16578173168779264
            var service = GetAuthenticatedService();
            var response = await service.FavoriteTweetAsync(new FavoriteTweetOptions { Id = 16578173168779264 });
            var fave = response.Content;
            ...
            var response2 = await service.UnfavoriteTweetAsync(new UnfavoriteTweetOptions { Id = 16578173168779264 });
            var unfave = response2.Content;
            Assert.IsTrue(response.RequestSucceeded);
            Assert.IsNotNull(unfave);
        }

        [Test]
        public async void Can_get_favorites()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListFavoriteTweetsAsync(new ListFavoriteTweetsOptions());
            var tweets = response.Content;
        ...
        [Test]
        public async void Can_get_friends_or_followers_with_next_cursor()
        {
            var service = new TwitterService(_consumerKey, _consumerSecret);
            service.AuthenticateWith(_accessToken, _accessTokenSecret);

            var response = await service.ListFollowersAsync(new ListFollowersOptions { ScreenName = _hero });
            var followers = response.Content;
            Assert.IsNotNull(followers);
        ...
        public async void Can_create_and_destroy_saved_search()
        {
            ...
            var searches = (await service.ListSavedSearchesAsync()).Content;
            Assert.IsNotNull(searches);

            var existing = searches.SingleOrDefault(s => s.Query.Equals("tweetsharp"));
            if (existing != null)
            {
                var response = await service.DeleteSavedSearchAsync(new DeleteSavedSearchOptions { Id = existing.Id });
                var deleted = response.Content;
                Assert.IsNotNull(deleted);
                Assert.IsNotNullOrEmpty(deleted.Query);
                Assert.AreEqual(deleted.Query, existing.Query);
            }

            var response2 = await service.CreateSavedSearchAsync(new CreateSavedSearchOptions { Query = "tweetsharp" });
            var search = response2.Content;
        ...
        {
            var service = GetAuthenticatedService();
            var response = await service.SearchAsync(new SearchOptions { Q = "tweetsharp", Count = 10 });
        ...
        [Test]
        public async void Can_search_with_geo_and_lang()
        {
            var italyGeoCode = new TwitterGeoLocationSearch(41.9, 12.5, 10, TwitterGeoLocationSearch.RadiusType.Mi);
            var service = GetAuthenticatedService();
            var response = await service.SearchAsync(new SearchOptions { Q = "papa", Geocode = italyGeoCode, Lang = "en", Count = 100, });
            var results = response.Content;
        ...
        [Test]
        public async void Searches_with_explicit_include_options_still_work()
        {
            var service = GetAuthenticatedService();
            var response = await service.SearchAsync(new SearchOptions
            {
                Count = 500,
        ...
        [Test]
        public async void Can_get_raw_source_from_search()
        {
            var service = GetAuthenticatedService();
            var response = await service.SearchAsync(new SearchOptions { Q = "tweetsharp", Count = 10 });
            var results = response.Content;
        ...
        [Test]
        public async void Can_get_friendship_info()
        {
            var service = GetAuthenticatedService();
            var response = await service.GetFriendshipInfoAsync(new GetFriendshipInfoOptions { SourceScreenName = "jdiller", TargetScreenName = "danielcrenna" });
        ...
        public async void Can_get_user_suggestion_categories_and_users()
        {
            ...
            var service = GetAuthenticatedService();
            var response = await service.ListSuggestedUserCategoriesAsync(new ListSuggestedUserCategoriesOptions());
            ...
            var response2 = await service.ListSuggestedUsersAsync(new ListSuggestedUsersOptions() { Slug = categories.First().Slug });
            var suggestions = response2.Content;
        ...
        [Test]
        public async void Can_get_tweet()
        {
            var service = GetAuthenticatedService();
            var response = await service.GetTweetAsync(new GetTweetOptions { Id = 10080880705929216 });
            var tweet = response.Content;
        ...
        public async void Can_delete_direct_message()
        {
            ...
            var response2 = await service.DeleteDirectMessageAsync(new DeleteDirectMessageOptions { Id = created.Id });
            var deleted = response2.Content;
            Assert.IsNotNull(deleted);
            Assert.AreEqual(deleted.Id, created.Id);
        }

        [Test]
        public async void Can_get_entities_on_direct_messages()
        {
            var service = new TwitterService { IncludeEntities = true };
            service.AuthenticateWith(_consumerKey, _consumerSecret, _accessToken, _accessTokenSecret);

            var response = await service.ListDirectMessagesSentAsync(new ListDirectMessagesSentOptions());
            var tweets = response.Content;
            if (!tweets.Any())
            {
        ...
        [Test]
        public async void Can_get_entities_on_timeline()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListTweetsOnHomeTimelineAsync(new ListTweetsOnHomeTimelineOptions());
            var tweets = response.Content;
        ...
        [Test]
        public async void Can_coalesce_entities_on_timeline()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListTweetsOnHomeTimelineAsync(new ListTweetsOnHomeTimelineOptions());
            var tweets = response.Content;
        ...
        [Test]
        public async void Can_get_tweets_on_user_timeline_with_since_paging()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListTweetsOnUserTimelineAsync(new ListTweetsOnUserTimelineOptions { Count = 200 });
            var tweets = response.Content.ToList();
            ...
            var response2 = await service.ListTweetsOnUserTimelineAsync(new ListTweetsOnUserTimelineOptions { SinceId = sinceId, Count = 200 });
            var tweets2 = response2.Content;
        ...
        [Test]
        public async void Can_get_tweets_on_specified_user_timeline()
        {
            var service = GetAuthenticatedService();

            var response = await service.ListTweetsOnUserTimelineAsync(new ListTweetsOnUserTimelineOptions { ScreenName = "mabster" });
            var tweets = response.Content;
            foreach (var tweet in tweets)
            {
                Assert.IsNotNull(tweet.RawSource);
        ...
        [Test]
        public async void Can_get_user_lists()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListListsForAsync(new ListListsForOptions() { ScreenName = _hero });
        ...
        [Test]
        public async void Can_create_and_delete_list()
        {
            var service = GetAuthenticatedService();
            ...
            var response2 = await service.DeleteListAsync(new DeleteListOptions { ListId = list.Id });
        ...
        [Test]
        public async void Can_get_followers_ids()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListFollowerIdsOfAsync(new ListFollowerIdsOfOptions() { ScreenName = _hero });
            var followers = response.Content;
            Assert.IsNotNull(followers);
            Assert.IsTrue(followers.Count > 0);
        }
        ...
        [Test]
        public async void Can_get_friend_ids()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListFriendIdsOfAsync(new ListFriendIdsOfOptions() { ScreenName = _hero });
        ...
        [Test]
        public async void Can_get_available_local_trend_locations()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListAvailableTrendsLocationsAsync();
            var locations = response.Content;
        ...
        [Test]
        [Ignore("Images not ready yet")]
        public async void Can_update_profile_image()
        {
            var service = GetAuthenticatedService();
            var response = await service.UpdateProfileImageAsync(new UpdateProfileImageOptions { ImagePath = "daniel_8bit.png" });
        ...
        [Test]
        public async void Can_get_local_trends()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListLocalTrendsForAsync(new ListLocalTrendsForOptions { Id = 4118 });
            var trendList = response.Content;
        ...
        [Test]
        public async void Can_get_multiple_user_profiles()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListUserProfilesForAsync(new ListUserProfilesForOptions() { ScreenName = new[] { "danielcrenna", "jdiller" } });
        ...
        private static void AssertRateLimitStatus<T>(TwitterResponse<T> response)
        {
            var rate = response.RateLimitStatus;
            Assert.IsNotNull(rate);
        ...
        [Test]
        public async void Can_get_friendship_lookup()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListFriendshipsForAsync(new ListFriendshipsForOptions() { ScreenName = new[] { "danielcrenna" } });
            var friendships = response.Content;
            Assert.IsNotNull(friendships);
        }

        [Test]
        public async void Can_loop_through_followers()
        {
            var service = GetAuthenticatedService();
            var response = await service.GetUserProfileAsync(new GetUserProfileOptions());
            ...
            var count = 0;
            var response2 = await service.ListFollowersAsync(new ListFollowersOptions { UserId = me.Id });
            var followers = response2.Content;
            count += followers.Count;
            while (followers.NextCursor != 0)
            {
                response2 = await service.ListFollowersAsync(new ListFollowersOptions { UserId = me.Id, Cursor = followers.NextCursor });
                followers = response2.Content;
                count += followers.Count;
            }
        ...
        [Test]
        public async void Can_list_tweets_on_list()
        {
            var service = GetAuthenticatedService();
            var response = await service.ListTweetsOnListAsync(new ListTweetsOnListOptions
        ...
        [Test]
        public async void Can_get_rate_limit_status_summary()
        {
            var service = GetAuthenticatedService();
            var response = await service.GetRateLimitStatusAsync(new GetRateLimitStatusOptions());
        ...
        [Test]
        public async void Can_Deserialize_Integer_GeoCoordinates()
        {
            //coordinates of this tweet are 2 integers  "{\"type\":\"Point\",\"coordinates\":[10, 234]}";
            TwitterService service = GetAuthenticatedService();
            var response = await service.GetTweetAsync(new GetTweetOptions() { Id = 294853375609163776 });
            var tweet = response.Content;
            Assert.NotNull(tweet);
        }

        [Test]
        public async void Recursive_issues_on_private_accounts()
        {
            TwitterService service = GetAuthenticatedService();
            var response = await service.ListTweetsOnUserTimelineAsync(new ListTweetsOnUserTimelineOptions() { ScreenName = "ventamatic" });
            var tweets2 = response.Content;
